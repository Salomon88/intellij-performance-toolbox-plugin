...
public class ImageHelper {
    ...
    public static Image loadImage(String imageName) {
        // TODO it is like a WA (Thread.currentThread().setContextClassLoader(ImageHelper.class.getClassLoader()))
        URL imageUrl = ImageHelper.class.getClassLoader().getResource(IMAGE_PATH + imageName);
        if (imageUrl == null) {
